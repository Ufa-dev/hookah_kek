package com.hookah.kek_hookah.feature.audit.flavor.api

import com.hookah.kek_hookah.feature.audit.flavor.internal.usecase.ListFlavorAuditQuery
...
@RestController
@RequestMapping("/api/v1/audit/flavor")
class FlavorAuditController(private val query: ListFlavorAuditQuery) {
    ...
    ): ResponseEntity<Slice<FlavorAuditRecord>> =
        query.execute(
